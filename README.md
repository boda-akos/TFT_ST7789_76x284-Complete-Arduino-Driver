...
On these chips, the driver itself uses about 10K of flash. On the CH32V003, roughly 6K remains free, which is still usable. The CH32V006 has ample space, but it is poorly supported by Arduino. The only non-official core that successfully compiles code for the V006 is the CH32VM00X core by Maxint-RD, available here:
github.com/maxint-rd/arduino_core_ch32/tree/support-CH32V002F4-CH32V006F8/variants/CH32VM00X.
 
 More about this https://github.com/openwch/arduino_core_ch32/pull/200, author Maxint-RD, select CH32VM00X core. 
